...
nyc_crimes_timeseries_weekly
ggplot(nyc_crimes_timeseries_weekly, aes(Crime, Count)) +
  geom_bar(stat="identity", color = "blue", fill = "lightblue") +
  facet_grid(cols=vars(Boro), rows=vars(Qtr))+
  ggtitle("Count of Park Crimes by Category") + 
  labs(x = "Crime Category", y = "Count of Reports") +
