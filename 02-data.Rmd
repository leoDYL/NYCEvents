...
[NYC Parks Crime Statistics](https://www1.nyc.gov/site/nypd/stats/crime-statistics/park-crime-stats.page) This data source contains multiple data files for each quarter from 2014 to the third quarter of 2021. In total, it contains 32312 rows and 13 columns Below is the schema of the dataset. 
```{r}
knitr::kable(
  tibble(
    "Column Name" = c(
